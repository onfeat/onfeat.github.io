...
".rssbook .info{color:#666;font-size:10px;}",
...
".rssbutton input{background: #057DC8;border: 1px solid #88b3e6; color: #FFFFFF; cursor: pointer;font-weight: bold;width:auto;display:block;height:auto;line-height:auto;*line-height:auto;text-align:center;}",
...
"<div class=\"rssbutton\"><input type=\"submit\" value=\"点击系统自动发送资料\"></div>",
"</form>",
"</div></div>"].join(""));
